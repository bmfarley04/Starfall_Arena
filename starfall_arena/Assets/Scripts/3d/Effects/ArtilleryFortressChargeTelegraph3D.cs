...
public class ArtilleryFortressChargeTelegraph3D : MonoBehaviour
{
    private const string DefaultEmissionColorProperty = "_EmissionColor";

    [Header("Renderers")]
    [Tooltip("Renderers that should glow during the artillery fortress charge tell. If empty and Auto Collect Child Renderers is enabled, all child renderers are used.")]
