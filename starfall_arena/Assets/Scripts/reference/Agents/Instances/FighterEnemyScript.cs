...
/// </summary>
public class FighterEnemyScript : EnemyScript
{
    ...
    protected override void Start()
    {
        ...
        if (_target != null)
        {
            _playerScript = _target.GetComponent<PlayerScript>();
        }
    }
    ...
    private void FireProjectile()
    {
        ...
        {
            int projectileTurretCount = Mathf.Min(4, turrets.Count);
    ...
    private void FireBeam()
    {
        ...
        if (turrets != null && turrets.Count >= 5)
        {
